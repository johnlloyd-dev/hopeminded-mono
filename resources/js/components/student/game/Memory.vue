...
export default {
    ...
    async created() {
        await axios.get("https://firebasestorage.googleapis.com/v0/b/hopeminded-d6a43.appspot.com/o/game-background%2Fgame4.mp4?alt=media&token=bdc4ca16-1fe8-4c26-ad45-00e3b09eadf1")
    },
    mounted() {
        this.initQuizInfo()
    },
