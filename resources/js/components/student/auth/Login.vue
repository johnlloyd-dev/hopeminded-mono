<template>
    <body class="position-relative">
        ...
        <div class="card px-5 rounded-0 w-50">
            ...
            <h4 class="text-center mb-2 font-weight-bold title-header mt-3">Student Login</h4>
            <div class="card-body">
                <form>
                    <div class="row mb-2">
                    ...
                    <div class="text-center mb-3">
                        <button @click.prevent="login" v-if="!isLoading" style="font-weight: bold; width: 120px;" type="button" class="btn btn-primary">Login</button>
                        <button v-else disabled style="font-weight: bold; width: 120px;" type="button" class="btn btn-primary pb-0">
                            <Loading/>
                        </button>
                    </div>
                    <div class="text-center">
                        <span style="font-weight: bold">Don't have an account yet? <a class="cursor-pointer"
                                style="font-weight: bold" @click="redirectStudentRegister">Register</a></span>
                    </div>
                </form>
            </div>
        </div>
