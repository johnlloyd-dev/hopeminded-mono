                    ...
                    <div class="scrollbar position-relative" id="scrollbar1">
                        <template v-if="!isLoading">
                            <div v-if="data.length" class="row">
                                ...
                                <button :disabled="(Object.keys(skillTest).length < quantityRequirement[0].value || !passedSkillTest) || (availableQuizRetakes.hasOwnProperty(filteredFlag) && availableQuizRetakes[filteredFlag].allowed_retake === 0)"
