                    ...
                    <div class="scrollbar position-relative" id="scrollbar1">
                        <template v-if="!isLoading">
                            <div v-if="data.length" class="row">
                                ...
                                <hr class="w-75">
                                <button :disabled="(Object.keys(skillTest).length < quantityRequirement[1].value || !passedSkillTest) || (availableQuizRetakes.hasOwnProperty(filteredFlag) && availableQuizRetakes[filteredFlag].allowed_retake === 0)"
                                    @click="$router.push('/quiz-matching-game')"
